...
def main(
    ...
    is_in_domain_required: bool = True,
    is_zero_shot_required: bool = True,
    ...
    if is_in_domain_required:
        ...
        agg_score_dict["in-domain"] = in_domain_agg_score_df

    if is_zero_shot_required:
        ...
        agg_score_dict['zero-shot'] = zero_shot_agg_score_df
